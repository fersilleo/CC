...
@Service
public class InventorDertimDeleteService implements AbstractDeleteService<Inventor, Dertim>{
	...
	@Override
	public void delete(final Request<Dertim> request, final Dertim entity) {
		assert request != null;
		assert entity != null;
